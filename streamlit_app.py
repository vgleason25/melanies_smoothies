...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        ...
        st.subheader(fruit_chosen + ' Nutrition Information') #new per B03L10P04
        smoothiefroot_response = requests.get("https://my.smoothiefroot.com/api/fruit/" + fruit_chosen) #change watermelon to fruit_chosen
